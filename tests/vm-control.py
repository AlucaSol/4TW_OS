...
allowed = {"status", "screenshot", "battery", "brightness", "escape", "shutdown", "powerbutton", "quit", "battery-series", "brightness-series", "tab", "enter", "down"}
...
elif action in {"battery", "brightness", "escape", "shutdown", "battery-series", "brightness-series", "tab", "enter", "down"}:
    control = action.removesuffix("-series")
    keys = {"battery": ["ctrl", "alt", "b"], "brightness": ["ctrl", "alt", "right"],
            "escape": ["alt", "f4"], "shutdown": ["ctrl", "alt", "delete"],
            "tab": ["tab"], "enter": ["ret"], "down": ["down"]}[control]
