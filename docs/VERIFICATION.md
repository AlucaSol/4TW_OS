...
```text
54d80f00557f047660b863796c168f73f03736bf7cd4df62f30b128f23054ce1
```
...
| Network time | Chrony is installed and enabled; packaged `/etc/chrony/chrony.conf` retains `rtcsync` |
